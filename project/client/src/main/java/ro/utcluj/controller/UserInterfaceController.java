...
public class UserInterfaceController {
    ...
    @FXML private TextArea textAreaUser;
    ...
    private void handleSendMessageButton(Event event){
        messageServiceInterface.addMessage(loggedUser.getUsername(), textAreaUser.getText());
        errorMessageText.setText("Your message has been successfully sent!");
        errorMessageText.setFill(Color.GREEN);
    }
}
