...
public class User {
    ...
    public User(String name, String username, String password, String email, String address, String phone_number, String user_role, Double balance_account, Set<UserProduct> userProducts, Set<FavoriteProduct> favoriteProducts) {
        this.name = name;
        this.username = username;
        this.password = password;
        this.email = email;
