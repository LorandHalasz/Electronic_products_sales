...
public class AdminInterfaceController {
    ...
    @Autowired
    public AdminInterfaceController(UserServiceInterface userService, ProductServiceInterface productService, UserProductServiceInterface userProductService, ApplicationContext applicationContext, NotificationService notificationService){
